...
import { Shield, Globe, Users, Zap, Target, Lock } from "lucide-react";
...
const values = [
  {
    ...
    description: "Protecting your data and transactions is our absolute priority."
  },
  {
    icon: Zap,
    title: "Continuous Innovation",
    description: "We use the latest AI advancements to stay one step ahead of fraud."
  },
  {
    icon: Users,
    title: "Customer Centric",
    description: "Our success is measured by the peace of mind we bring to our clients."
  }
];
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-24">
            ...
            >
              Orylo was born from a simple mission: to enable businesses to grow without fearing fraud.
            </motion.p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
            ...
            >
              ...
              <div className="space-y-6 text-zinc-400 text-lg">
                <p>
                  Online fraud is a plague costing businesses billions every year. At Orylo, we believe technology shouldn't be a source of worry, but a driver for growth.
                </p>
                <p>
                  We have developed proprietary technology based on artificial intelligence that analyzes thousands of data points in real-time to detect suspicious behaviors before they become problems.
                </p>
                <p>
                  Our team of cybersecurity and data science experts works tirelessly to refine our models and protect our clients against emerging threats.
                </p>
              </div>
            </motion.div>
            <motion.div
